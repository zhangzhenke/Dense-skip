...
class VisionTransformer(timm.models.vision_transformer.VisionTransformer):
    ...
    def __init__(self, 
        ...
        self.decoder0 = nn.Sequential(
            Conv2DBlock(3, 32, 3, dropout=0.0),
            Conv2DBlock(32, 64, 3, dropout=0.0),
        ...
        self.decoder1 = nn.Sequential(
            Deconv2DBlock(1024, 512, dropout=0.0),
            Deconv2DBlock(512, 256, dropout=0.0),
            Deconv2DBlock(256, 128, dropout=0.0),
    ...
    def create_upsampling_branch(self) -> nn.Module:
        ...
        decoder3_upsampler = nn.Sequential(
            Conv2DBlock(1024, 512, dropout=0.0),
    ...
    def _forward_upsample(
        ...
        b2 = self.upsample2(b2 + b3 + self.upsample3(b4) ) 
        ...
        b1 = self.upsample1(b1 + b2 + self.upsample2(b3) + self.upsample2(self.upsample3(b4)) )
        ...
        branch_output = self.upsample0(b0 + b1 + self.upsample1(b2) + self.upsample1(self.upsample2(b3))
                                        + self.upsample1(self.upsample2(self.upsample3(b4))) )
